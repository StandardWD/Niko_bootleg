...
export default function MenuLeft(){
  ...
  useEffect(() => {
    ...
    <div className="flex flex-col fixed left-5 top-1/2 -translate-y-1/2 z-20 gap-5">
        ...
        <Link href={"#Jordan"} className={`bg-white ${where == "Jordan" ? "bg-red-900" : ""} font-niko font-bold text-5xl hover:bg-red-900 bg-clip-text text-transparent hover:w-full transition-background cursor-pointer`}>JORDAN</Link>
    </div>
